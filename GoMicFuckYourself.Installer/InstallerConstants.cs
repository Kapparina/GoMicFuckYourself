...
internal static class InstallerConstants
{
    ...
    public const string ProductDescription =
        "Enforces a selected microphone as the default capture and communications device and re-applies the configured input volume.";

    public const string SupportContact = "GitHub Releases";

    public const string Comments =
        "Installs the GoMicFuckYourself agent, tray app, and shared machine configuration. Release notes and changelogs are published on the GitHub Releases page.";
